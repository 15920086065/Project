...
import com.android.functiontest.ui.XKActivityTest;
...
public class MainPreFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener{
    ...
    private void init(){
        ...
        preference18 = (Preference)findPreference("preference18");
    ...
    public boolean onPreferenceClick(Preference preference) {
        if (preference==preference1){
            ...
            XKActivityTest.openActivity(getActivity());
        }else if (preference==preference18){
