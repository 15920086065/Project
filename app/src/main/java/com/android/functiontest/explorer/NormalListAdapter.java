...
public class NormalListAdapter extends ArrayAdapter<FileInfo>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(ConfigUtil.USE_STORAGEMANAGER_TO_FILL && hasFileName)
        	text.setText(info.fileName);
        else if(info.file.getPath().equals(flash_dir))
        	...
        	if(ConfigUtil.NOT_USE_SDCRAD){
        		text.setText(resources.getString(R.string.str_usb2_name));
        	}else{
        ...
        else if(info.file.getPath().equals(internal_dir))
        	text.setText(resources.getString(R.string.str_internal_name));
        else
        	text.setText(info.file.getName());
        //text_choice.setText(info.toString());
        /**/
		 ...
		 if(info.isChoice){
						...
						text.setText(info.fileName);
								...
								if(ConfigUtil.NOT_USE_SDCRAD){
										text_choice.setText(resources.getString(R.string.str_usb2_name));
								}else{
						...
						text_choice.setText(resources.getString(R.string.str_internal_name));
					 else
        ...
        if(info.file.getPath().endsWith(sdcard_dir) || 
        	...
        	info.file.getPath().endsWith(internal_dir)){
        	text_right.setText("");
        }else{        	
