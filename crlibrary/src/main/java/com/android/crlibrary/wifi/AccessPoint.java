...
public class AccessPoint extends Preference {
    ...
    protected void onBindView(View view) {
        ...
        if (mRssi == Integer.MAX_VALUE) {
            ...
            if ((security != SECURITY_NONE) ){
                ...
                signal.setImageResource(R.drawable.wifi_lock_level);
            }else {
                signal.setImageLevel(getLevel());
                signal.setImageResource(R.drawable.wifi_signal_level);
            }
        }
    }
    ...
    private void refresh() {
        ...
        if (mState != null) { // This is the active connection
            if (Summary.get(context, mState)!=null){
